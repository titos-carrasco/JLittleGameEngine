...
public class MovePlayer {
    ...
    public MovePlayer(String resourceDir) {
        ...
        lge.imageManager.loadImages("heroe_right", resourceDir + "/images/Swordsman/Idle/Idle_000.png", 0.16, false,
                false);
        lge.imageManager.loadImages("heroe_left", resourceDir + "/images/Swordsman/Idle/Idle_000.png", 0.16, true,
                false);
